...
This app can be used for testing, production and pre-production.
The code is open source and is available under https://github.com/mr-elbe5/SwiftyBandika.git.
The base packages are also open source and available at github from the same author.

If you prefer running the production server without GUI, you can use the command line version SwiftyBandikaCL from https://github.com/mr-elbe5/SwiftyBandikaCL.git.
